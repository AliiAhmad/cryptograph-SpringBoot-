...
public class Binance
{
    ...
    {
        return "Binance [lastQty = "+lastQty+", count = "+count+", symbol = "+symbol+", prevClosePrice = "+prevClosePrice+", lastPrice = "+lastPrice+", openTime = "+openTime+", openPrice = "+openPrice+", quoteVolume = "+quoteVolume+", weightedAvgPrice = "+weightedAvgPrice+", priceChange = "+priceChange+", lowPrice = "+lowPrice+", firstId = "+firstId+", bidPrice = "+bidPrice+", closeTime = "+closeTime+", priceChangePercent = "+priceChangePercent+", lastId = "+lastId+", volume = "+volume+", askQty = "+askQty+", highPrice = "+highPrice+", bidQty = "+bidQty+", askPrice = "+askPrice+"]";
    }
}
