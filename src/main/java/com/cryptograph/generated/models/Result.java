...
public class Result
{
    ...
    {
        return "Bittrex Result [OpenSellOrders = "+OpenSellOrders+", TimeStamp = "+TimeStamp+", Last = "+Last+", Low = "+Low+", Created = "+Created+", PrevDay = "+PrevDay+", OpenBuyOrders = "+OpenBuyOrders+", Volume = "+Volume+", BaseVolume = "+BaseVolume+", Bid = "+Bid+", Ask = "+Ask+", MarketName = "+MarketName+", High = "+High+"]";
    }
}
